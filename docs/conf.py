...
htmlhelp_basename = 'PortalGundoc'
...
latex_documents = [
    (master_doc, 'PortalGun.tex', 'Portal Gun Documentation',
     'Vadim Fedorov', 'manual'),
]
...
man_pages = [
    (master_doc, 'portalgun', 'Portal Gun Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PortalGun', 'Portal Gun Documentation',
     author, 'PortalGun', 'One line description of project.',
     'Miscellaneous'),
]
